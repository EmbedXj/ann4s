...
import org.apache.spark.ml.nn.IndexedVectorWithNorm
...
class ArithmeticTest extends FunSuite {
  ...
  test("IndexedVectorWithNorm: norm") {
    ...
    val v = new IndexedVectorWithNorm(0, ar)
  ...
  test("VectorWithNorm: copy") {
    ...
    val v1 = new IndexedVectorWithNorm(1, ar1)
    val v2 = new IndexedVectorWithNorm(2, ar2)
